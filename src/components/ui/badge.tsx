...
const badgeVariants = cva(
  "inline-flex items-center transition-all relative max-w-full whitespace-nowrap [&_svg]:inline-block [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        xs: "text-[10px] px-1.5 h-5 rounded-sm border gap-1",
